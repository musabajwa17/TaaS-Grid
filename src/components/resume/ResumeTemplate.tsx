...
import { Mail, Phone, MapPin, Linkedin, Github, User, Briefcase, GraduationCap, Code, Award, Sparkles } from "lucide-react";
import { ParsedData } from "@/types/ParsedData"; // adjust the path if needed
