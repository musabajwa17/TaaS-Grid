...
import { useUploadResume } from "@/hooks/useUploadResume";
import { useUploadCV } from "@/hooks/useUploadCV";
import CvTemplate from "./CvTemplate"; // ✅ import your target component
...
export default function CvForge() {
  ...
  // ✅ Enrich CV button → localStorage + show Finalized Component
  const enrichCv = () => {
    localStorage.setItem("parsedData", JSON.stringify(parsedData));
    setShowFinalized(true); // ✅ Switch to FinalizedStudentResume
  };
  ...
  // ✅ Default Resume Upload/Parse View
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-6">
      <div className="max-w-5xl mx-auto">
        {/* Error */}
