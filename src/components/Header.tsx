...
//               {["Home", "Jobs", "Services", "Contact", "About","CV Builder"].map(
//                 (item, index) => (
//                   <a
//                     key={item}
//                     href="#"
//                     className="relative px-5 py-2.5 text-gray-700 font-bold text-sm hover:text-[#00bb98] transition-all duration-500 group"
