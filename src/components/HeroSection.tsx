...
// import { Briefcase, TrendingUp, Users, FileText, BarChart3, Database, Gavel, Sparkles, Zap, Rocket } from 'lucide-react';
...
//   const modules = [
//     { name: 'Resume Building', icon: FileText, color: 'from-violet-600 via-purple-600 to-fuchsia-600', shadow: 'shadow-purple-500/50' },
//     { name: 'Progress Tracking', icon: BarChart3, color: 'from-cyan-500 via-blue-600 to-indigo-600', shadow: 'shadow-blue-500/50' },
//     { name: 'Talent Pool', icon: Database, color: 'from-orange-500 via-red-500 to-pink-600', shadow: 'shadow-red-500/50' },
//     { name: 'Project Bidding', icon: Gavel, color: 'from-emerald-500 via-teal-500 to-cyan-500', shadow: 'shadow-teal-500/50' }
//   ];
...
//   useEffect(() => {
//     const interval = setInterval(() => {
//       setParticles(prev => [...prev, { id: Date.now(), x: Math.random() * 100, y: Math.random() * 100 }]);
//       setTimeout(() => {
...
//         {/* Gradient mesh */}
//         <div className="absolute inset-0 bg-gradient-to-br from-violet-950 via-slate-900 to-cyan-950"></div>
...
//       {/* Mouse follower glow */}
//       <div 
//         className="absolute w-96 h-96 bg-gradient-to-r from-purple-500 to-cyan-500 rounded-full blur-3xl opacity-10 pointer-events-none transition-all duration-1000"
//         style={{
//           left: `${mousePos.x}px`,
//           top: `${mousePos.y}px`,
...
//               <span className="text-sm text-purple-300 font-medium">Next-Gen Talent Platform</span>
//             </div>

//             {/* Headings with incredible animations */}
//             <div className="space-y-6">
//               <div className="group cursor-pointer">
//                 <div className="flex items-center gap-5 transform transition-all duration-500 hover:translate-x-4">
...
//                     <div className="relative w-16 h-16 bg-gradient-to-br from-blue-600 to-cyan-600 rounded-2xl flex items-center justify-center transform group-hover:rotate-12 transition-transform">
//                       <Briefcase className="w-8 h-8 text-white" strokeWidth={2.5} />
//                     </div>
//                   </div>
//                   <h2 className="text-6xl font-black bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-500 bg-clip-text text-transparent group-hover:scale-105 transition-transform">
//                     Hire Faster
//                   </h2>
//                 </div>
//               </div>
...
//                     <div className="relative w-16 h-16 bg-gradient-to-br from-purple-600 to-pink-600 rounded-2xl flex items-center justify-center transform group-hover:rotate-12 transition-transform">
//                       <TrendingUp className="w-8 h-8 text-white" strokeWidth={2.5} />
//                     </div>
//                   </div>
//                   <h2 className="text-6xl font-black bg-gradient-to-r from-purple-400 via-pink-400 to-purple-500 bg-clip-text text-transparent group-hover:scale-105 transition-transform">
//                     Train Smarter
//                   </h2>
//                 </div>
//               </div>
...
//                 <div className="flex items-center gap-5 transform transition-all duration-500 hover:translate-x-4">
//                   <div className="relative">
//                     <div className="absolute inset-0 bg-gradient-to-r from-emerald-600 to-teal-600 rounded-2xl blur-xl opacity-60 group-hover:opacity-100 transition-opacity"></div>
//                     <div className="relative w-16 h-16 bg-gradient-to-br from-emerald-600 to-teal-600 rounded-2xl flex items-center justify-center transform group-hover:rotate-12 transition-transform">
//                       <Users className="w-8 h-8 text-white" strokeWidth={2.5} />
//                     </div>
//                   </div>
//                   <h2 className="text-6xl font-black bg-gradient-to-r from-emerald-400 via-teal-400 to-emerald-500 bg-clip-text text-transparent group-hover:scale-105 transition-transform">
//                     Grow Together
//                   </h2>
//                 </div>
//               </div>
...
//             <div className="relative">
//               <div className="absolute inset-0 bg-gradient-to-r from-purple-500/20 to-cyan-500/20 blur-2xl"></div>
//               <p className="relative text-2xl text-slate-300 leading-relaxed font-light">
//                 An integrated <span className="text-transparent bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text font-semibold">ecosystem</span> connecting students, employers and educators for the <span className="text-transparent bg-gradient-to-r from-pink-400 to-orange-400 bg-clip-text font-semibold">future of talent</span>
//               </p>
//             </div>

//             {/* Epic Buttons */}
//             <div className="flex flex-wrap gap-6 pt-6">
//               <button className="group relative px-10 py-5 overflow-hidden rounded-2xl transition-all duration-300 hover:scale-105">
//                 <div className="absolute inset-0 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 animate-gradient-x"></div>
//                 <div className="absolute inset-0 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 opacity-0 group-hover:opacity-100 blur-xl transition-opacity"></div>
...
//               <button className="group relative px-10 py-5 overflow-hidden rounded-2xl border-2 border-purple-500/50 backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:border-purple-400">
//                 <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 to-cyan-500/10 group-hover:from-purple-500/20 group-hover:to-cyan-500/20 transition-all"></div>
//                 <div className="relative flex items-center gap-3 text-white font-bold text-lg">
...
//           {/* Right Side - INSANE 3D Orbit Animation */}
...
//               <div className="absolute inset-4 border-2 border-dotted border-cyan-500/30 rounded-full animate-spin-reverse"></div>
              
//               {/* Central tech hub */}
//               <div className="relative w-48 h-48 rounded-3xl bg-gradient-to-br from-slate-800 via-slate-900 to-black border border-purple-500/30 shadow-2xl transform-gpu hover:scale-110 transition-all duration-500">
//                 {/* Glowing edges */}
//                 <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-purple-500/20 via-transparent to-cyan-500/20 animate-pulse"></div>
                
//                 {/* Screen */}
//                 <div className="absolute inset-6 bg-gradient-to-br from-blue-950 to-purple-950 rounded-2xl overflow-hidden">
//                   {/* Screen content */}
//                   <div className="absolute inset-0 bg-gradient-to-br from-purple-600/30 to-cyan-600/30 animate-gradient-slow"></div>
//                   <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-20 bg-gradient-to-br from-purple-500 to-cyan-500 rounded-full blur-2xl animate-pulse"></div>
                  
//                   {/* Code-like animation */}
//                   {[...Array(5)].map((_, i) => (
//                     <div key={i} className="absolute left-4 bg-purple-400/50 h-1 rounded animate-code-flow" style={{
//                       top: `${20 + i * 15}%`,
...
//                 {/* Corner accents */}
//                 <div className="absolute top-2 left-2 w-8 h-8 border-t-2 border-l-2 border-purple-400/50"></div>
//                 <div className="absolute bottom-2 right-2 w-8 h-8 border-b-2 border-r-2 border-cyan-400/50"></div>
                
//                 {/* Base */}
//                 <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-32 h-2 bg-gradient-to-r from-purple-600 to-cyan-600 rounded-full blur-sm"></div>
//               </div>
...
//                 const pos = getOrbitPosition(index, 200);
//                 const rotation = (Date.now() / 20) % 360;
//                 const orbitAngle = (index * 360) / modules.length + rotation;
...
//                     style={{
//                       transform: `rotate(${orbitAngle}deg) translateX(200px) rotate(-${orbitAngle}deg) ${isActive ? 'scale(1.2)' : 'scale(1)'}`,
...
//                       {/* Mega glow effect */}
//                       {isActive && (
//                         <div className={`absolute inset-0 bg-gradient-to-r ${module.color} blur-2xl opacity-80 animate-pulse scale-150`}></div>
//                       )}
                      
//                       {/* Card */}
//                       <div className={`relative w-40 h-40 bg-gradient-to-br ${module.color} rounded-3xl ${module.shadow} shadow-2xl flex flex-col items-center justify-center gap-4 border-2 border-white/30 backdrop-blur-sm transform transition-all duration-300 ${isActive ? 'rotate-0' : 'group-hover:rotate-6'}`}>
//                         {/* Icon container */}
//                         <div className="relative">
//                           <div className="absolute inset-0 bg-white/20 rounded-2xl blur-xl"></div>
//                           <div className="relative w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center backdrop-blur-sm">
...
//                         {/* Animated corners */}
//                         <div className="absolute top-3 left-3 w-4 h-4 border-t-2 border-l-2 border-white/60 animate-ping"></div>
//                         <div className="absolute bottom-3 right-3 w-4 h-4 border-b-2 border-r-2 border-white/60 animate-ping animation-delay-1000"></div>
...
//                       {isActive && (
//                         <div className={`absolute top-1/2 left-1/2 w-1 h-32 bg-gradient-to-b ${module.color} opacity-50 blur-sm -translate-x-1/2`}
//                           style={{transform: `translateX(-50%) rotate(${180 + orbitAngle}deg)`}}
//                         ></div>
//                       )}
//                     </div>
//                   </div>
...
//                   style={{
//                     background: `linear-gradient(135deg, ${i % 3 === 0 ? '#a855f7' : i % 3 === 1 ? '#06b6d4' : '#ec4899'}, transparent)`,
//                     top: '50%',
//                     left: '50%',
...
//         }
//         .animate-float { animation: float 3s ease-in-out forwards; }
...
//         }
//         .animate-code-flow { animation: code-flow 2s ease-in-out infinite; }
...
// const modules = [
//   { name: "HireConnect", color: "bg-gradient-to-br from-blue-600 to-blue-700", icon: "🤝" },
//   { name: "FYP Bridge", color: "bg-gradient-to-br from-amber-500 to-yellow-500", icon: "🌉" },
//   { name: "Idea Vault", color: "bg-gradient-to-br from-blue-700 to-blue-800", icon: "💡" },
//   { name: "ProjectHub", color: "bg-gradient-to-br from-yellow-500 to-amber-500", icon: "🚀" },
//   { name: "CV Forge", color: "bg-gradient-to-br from-blue-600 to-blue-700", icon: "📄" },
//   { name: "Talent Match", color: "bg-gradient-to-br from-amber-500 to-yellow-600", icon: "⭐" },
//   { name: "SkillBoost Pro", color: "bg-gradient-to-br from-blue-700 to-blue-800", icon: "📈" },
//   { name: "LearnEdge", color: "bg-gradient-to-br from-yellow-600 to-amber-600", icon: "🎓" }
// ];
...
//     modules[currentSet % 8],
//     modules[(currentSet + 1) % 8],
//     modules[(currentSet + 2) % 8],
//     modules[(currentSet + 3) % 8]
//   ];
...
//               <polygon points="50,0 93.3,25 93.3,75 50,100 6.7,75 6.7,25" fill="none" stroke="#93c5fd" strokeWidth="1"/>
//             </pattern>
//           </defs>
...
//         <div className="absolute top-40 right-32 w-2 h-2 bg-blue-300 rounded-full animate-pulse" style={{ animationDelay: '1s' }}></div>
//         <div className="absolute bottom-32 left-40 w-2 h-2 bg-blue-300 rounded-full animate-pulse" style={{ animationDelay: '2s' }}></div>
//         <div className="absolute top-1/3 right-20 w-3 h-3 bg-blue-400 rounded-full animate-pulse" style={{ animationDelay: '1.5s' }}></div>
//       </div>
...
//                 <h2 className="text-5xl lg:text-6xl font-bold text-blue-900 animate-slideInLeft">
//                   Hire Faster
//                 </h2>
//                 <h2 className="text-5xl lg:text-6xl font-bold text-blue-900 animate-slideInLeft" style={{ animationDelay: '0.2s' }}>
//                   Train Smarter
//                 </h2>
//                 <h2 className="text-5xl lg:text-6xl font-bold text-blue-900 animate-slideInLeft" style={{ animationDelay: '0.4s' }}>
//                   Grow Together
//                 </h2>
//               </div>
              
//               <p className="text-xl text-gray-700 leading-relaxed max-w-xl animate-slideInLeft" style={{ animationDelay: '0.6s' }}>
...
//               <button className="group px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 rounded-full text-white font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center gap-2">
//                 Explore Opportunities
//                 <span className="group-hover:translate-x-1 transition-transform duration-300">→</span>
//               </button>
//               <button className="group px-8 py-4 bg-white border-2 border-blue-600 rounded-full text-blue-700 font-semibold hover:bg-blue-50 hover:scale-105 transition-all duration-300 flex items-center gap-2">
//                 Hire Talent
//                 <span className="group-hover:translate-x-1 transition-transform duration-300">→</span>
//               </button>
//             </div>
...
//           {/* Right Side - Vertical Module Display */}
//           <div className="relative flex items-center justify-center">
//             <div className="relative w-full max-w-md">
              
//               {/* Domains Included Text */}
//               <div className="absolute -left-16 top-1/2 -translate-y-1/2 z-10">
//                 <h3 className="text-3xl font-bold">
//                   <span className="text-blue-700">Domains</span>
//                   <br />
...
//                   const rotation = index === 0 ? -15 : index === 1 ? 10 : index === 2 ? -8 : 12;
//                   const xOffset = index % 2 === 0 ? -20 : 20;
                  
//                   return (
//                     <div
//                       key={`${module.name}-${currentSet}-${index}`}
...
//                       {/* Connection Line */}
//                       {index < 3 && (
//                         <div className="absolute left-1/2 top-full h-6 w-0.5 bg-blue-300 z-0"></div>
//                       )}
                      
//                       {/* Module Card */}
//                       <div className={`${module.color} w-48 h-48 rounded-3xl shadow-2xl flex flex-col items-center justify-center cursor-pointer group hover:scale-110 transition-all duration-300 relative overflow-hidden z-10`}>
//                         {/* Shine effect */}
//                         <div className="absolute inset-0 bg-gradient-to-tr from-white/0 via-white/30 to-white/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 transform -translate-x-full group-hover:translate-x-full"></div>
                        
//                         <div className="relative z-10 text-center">
//                           <div className="text-5xl mb-3 filter drop-shadow-lg group-hover:scale-110 transition-transform duration-300">
//                             {module.icon}
//                           </div>
...
//                       {/* Side label */}
//                       <div className="absolute -right-32 top-1/2 -translate-y-1/2 flex items-center gap-3">
...
//                 <button className="relative px-10 py-4 bg-gradient-to-r from-blue-700 to-blue-800 rounded-full text-yellow-400 font-bold text-lg shadow-2xl hover:shadow-blue-500/50 transition-all duration-300 group overflow-hidden">
...
const modules = [
  { name: "HireConnect", color: "from-blue-600 to-blue-700", icon: "🏠", angle: 45 },
  { name: "FYP Bridge", color: "from-yellow-500 to-amber-500", icon: "💻", angle: 90 },
  { name: "Idea Vault", color: "from-blue-700 to-blue-800", icon: "⚡", angle: 135 },
  { name: "ProjectHub", color: "from-yellow-600 to-amber-600", icon: "🤖", angle: 180 },
  { name: "CV Forge", color: "from-blue-600 to-blue-700", icon: "🤝", angle: 225 },
  { name: "TalentMatch AI", color: "from-yellow-500 to-amber-500", icon: "🌉", angle: 270 },
  { name: "SkillBoost Pro", color: "from-blue-700 to-blue-800", icon: "💡", angle: 315 },
  { name: "LearnEdge", color: "from-yellow-600 to-amber-600", icon: "🚀", angle: 0 }
];
