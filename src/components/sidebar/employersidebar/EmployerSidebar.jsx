...
import Applicants from "@/components/dashboard/employer/Applicants";
...
export default function UserSidebar() {
  ...
  const stages = [
    ...
    { name: "View Applicants", icon: MapPin, color: "emerald" },
...
/>
      ...
      <main className="flex-1 flex flex-col min-h-screen overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto bg-white">
          {selected === "Dashboard Overview" && <EmployerDashboard />}
          {selected === "Job Post" && <JobPosting />}
          {selected === "View Applicants" && <Applicants />}
